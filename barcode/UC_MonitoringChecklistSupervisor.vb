...
Public Class UC_MonitoringChecklistSupervisor
    ...
    Private Sub DisabledSupervisorForm()
        CHK_FullCutTable.Enabled = False
        CHK_FullWasteBin.Enabled = False
        CHK_FulPallets.Enabled = False
        CHK_FullLineJogTable.Enabled = False
        ...
        CHK_GoodCuttingBlade.Enabled = False
        CHK_GoodCuttingTable.Enabled = False
        CHK_GoodControlPanel.Enabled = False
        ...
        CHK_GrainShort.Enabled = False
        CHK_GrainLong.Enabled = False
        TXT_Dimension1.Enabled = False
        TXT_Dimension2.Enabled = False
        CHK_CuttingFreeFromGreaseOil.Enabled = False
        CHK_CuttingFreeFromChippedOff.Enabled = False
        CHK_SquarenessAllSides.Enabled = False
        CHK_SquarenessAllSheets.Enabled = False
        CHK_CheckAllUps.Enabled = False
        CHK_SeleclAll.Enabled = False

        DTPOperator.Enabled = False
        DTPHelper1.Enabled = False
        DTPHelper2.Enabled = False

        TXT_CottonGLovesQty.Enabled = False
        TXT_ReturnedCottonGloves.Enabled = False
    ...
    Private Sub EnabledSupervisorForm()
        CHK_FullCutTable.Enabled = True
        CHK_FullWasteBin.Enabled = True
        CHK_FulPallets.Enabled = True
        CHK_FullLineJogTable.Enabled = True
        ...
        CHK_GoodCuttingBlade.Enabled = True
        CHK_GoodCuttingTable.Enabled = True
        CHK_GoodControlPanel.Enabled = True
        ...
        CHK_GrainShort.Enabled = True
        CHK_GrainLong.Enabled = True
        TXT_Dimension1.Enabled = True
        TXT_Dimension2.Enabled = True
        CHK_CuttingFreeFromGreaseOil.Enabled = True
        CHK_CuttingFreeFromChippedOff.Enabled = True
        CHK_SquarenessAllSides.Enabled = True
        CHK_SquarenessAllSheets.Enabled = True
        CHK_CheckAllUps.Enabled = True

        DTPOperator.Enabled = True
        DTPHelper1.Enabled = True
        DTPHelper2.Enabled = True

        TXT_CottonGLovesQty.Enabled = True
        TXT_ReturnedCottonGloves.Enabled = True
    ...
    Private Sub UC_MonitoringChecklistSupervisor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If dr.HasRows Then
                If dr.Read() Then
                    ...
                    TXT_CottonGLovesQty.Text = dr("flc_OLCcotglovQty").ToString()
            ...
            Try
                ...
                If dr.HasRows Then
                    If dr.Read() Then
                        ...
                        TXT_ReturnedCottonGloves.Text = dr("cotglovqty").ToString()
    ...
    Private Sub BTN_Save_Supervisor_Click(sender As Object, e As EventArgs) Handles BTN_Save_Supervisor.Click
        ...
        Dim FullPallets As String = ""
        Dim FullLineJogTable As String = ""
        ...
        If CHK_FullCutTable.Checked Then
            FullCutTable = "O"
        Else
            FullCutTable = "X"
        End If
        ...
        If CHK_FulPallets.Checked Then
            FullPallets = "O"
        Else
            FullPallets = "X"
        End If
        ...
        If CHK_FullLineJogTable.Checked Then
            FullLineJogTable = "O"
        Else
            FullLineJogTable = "X"
        End If
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                cmd.Parameters.AddWithValue("@flc_pallets", FullPallets)
                cmd.Parameters.AddWithValue("@flc_joggerTable", FullLineJogTable)
                ...
                cmd.Parameters.AddWithValue("@flc_OLCcotglovQty", TXT_CottonGLovesQty.Text)
                cmd.ExecuteNonQuery()
                con.Close()
        ...
        Try
            ...
            Dim GoodCuttingBlade As String = ""
            Dim GoodCuttingTable As String = ""


            Dim GoodControlPanel As String = ""
            ...
            If CHK_GoodCuttingBlade.Checked Then
                GoodCuttingBlade = "O"
            Else
                GoodCuttingBlade = "X"
            End If
            ...
            If CHK_GoodCuttingTable.Checked Then
                GoodCuttingTable = "O"
            Else
                GoodCuttingTable = "X"
            End If
            ...
            If CHK_GoodControlPanel.Checked Then
                GoodControlPanel = "O"
            Else
                GoodControlPanel = "X"
            End If
            ...
            If dr.HasRows Then
                ...
                cmd.Parameters.AddWithValue("@gmp_SaniCuttingBlade", GoodCuttingBlade)
                cmd.Parameters.AddWithValue("@gmp_SaniCuttingTable", GoodCuttingTable)
                cmd.Parameters.AddWithValue("@gmp_SaniControlPanel", GoodControlPanel)
        ...
        Dim GrainDirectionShort As String = ""
        Dim GrainDirectionLong As String = ""
        Dim FreeGreaseOilDust As String = ""
        Dim FreeChippedOffpart As String = ""
        Dim AllsidesLengthWidth As String = ""
        Dim AllSheetsTopBottom As String = ""
        Dim CheckAllups As String = ""


        Dim DimensionDecimal1 As Double
        Dim DimensionDecimal2 As Double

        Double.TryParse(TXT_Dimension1.Text, DimensionDecimal1)
        Double.TryParse(TXT_Dimension2.Text, DimensionDecimal2)



        If CHK_GrainShort.Checked Then
            GrainDirectionShort = "O"
        Else
            GrainDirectionShort = "X"
        End If

        If CHK_GrainLong.Checked Then
            GrainDirectionLong = "O"
        Else
            GrainDirectionLong = "X"
        End If



        If CHK_CuttingFreeFromGreaseOil.Checked Then
            FreeGreaseOilDust = "O"
        Else
            FreeGreaseOilDust = "X"
        End If
        ...
        If CHK_CuttingFreeFromChippedOff.Checked Then
            FreeChippedOffpart = "O"
        Else
            FreeChippedOffpart = "X"
        End If


        If CHK_SquarenessAllSides.Checked Then
            AllsidesLengthWidth = "O"
        Else
            AllsidesLengthWidth = "X"
        End If


        If CHK_SquarenessAllSheets.Checked Then
            AllSheetsTopBottom = "O"
        Else
            AllSheetsTopBottom = "X"
        End If
        ...
        If CHK_CheckAllUps.Checked Then
            CheckAllups = "O"
        Else
            CheckAllups = "X"
        End If
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                cmd.Parameters.AddWithValue("@Site", Form1.cmb_site.Text)
                cmd.Parameters.AddWithValue("@mcnum", FRM_MonitoringChecklistMain.TXT_MCNO.Text)
                cmd.Parameters.AddWithValue("@mspa_CUGDShort", GrainDirectionShort)
                cmd.Parameters.AddWithValue("@mspa_CutGDLong", GrainDirectionLong)
                cmd.Parameters.AddWithValue("@mspa_CUBlGreasefree", FreeGreaseOilDust)
                cmd.Parameters.AddWithValue("@mspa_CUBlChippedOff", FreeChippedOffpart)
                cmd.Parameters.AddWithValue("@mspa_CUSquareAllSh", AllSheetsTopBottom)
                cmd.Parameters.AddWithValue("@mspa_CUSquareAllSide", AllsidesLengthWidth)
                cmd.Parameters.AddWithValue("@mspa_CUChkUpsOuts", CheckAllups)
                cmd.Parameters.AddWithValue("@mspa_CUChkDim1", DimensionDecimal1)
                cmd.Parameters.AddWithValue("@mspa_CUChkDim2", DimensionDecimal2)
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                cmd.Parameters.AddWithValue("@CotglovQty", TXT_ReturnedCottonGloves.Text)
    ...
    'Private Sub CBO_Helper1_DropDown(sender As Object, e As EventArgs)
    '    'Dim position As String = "Helper"

    '    'Try
    '    '    con.Open()
    '    '    Dim cmd_viewsection As New SqlCommand("Select Name, Emp_num FROM  Employee WHERE Position = @position Order By Name ASC", con)
    '    '    cmd_viewsection.Parameters.AddWithValue("@position", position)
    '    '    Dim read_cmd As SqlDataReader = cmd_viewsection.ExecuteReader
    '    '    If read_cmd.HasRows Then
    '    '        While read_cmd.Read
    '    '            CBO_Helper1.Items.Add(dr("Name").ToString())
    '    '        End While
    '    '        read_cmd.Close()
    '    '    End If
    '    'Catch ex As Exception
    ...
    '    Try
    '        OpenConnection()
    '        cmd.CommandText = "Select Name, Emp_num FROM Employee WHERE Position = @position Order By Name ASC "
    '        cmd.CommandType = CommandType.Text
    '        cmd.Parameters.Clear()
    '        cmd.Parameters.AddWithValue("@position", "Helper")
    '        dr = cmd.ExecuteReader()
    '        If dr.HasRows Then
    '            While dr.Read()
    '                CBO_Helper1.Items.Add(dr("Name").ToString())
    '                'CBO_Helper1.Text = dr("Emp_num").ToString()
    ...
    'Private Sub CBO_Helper2_DropDown(sender As Object, e As EventArgs)
    '    Try
    '        OpenConnection()
    '        cmd.CommandText = "Select Name, Emp_num FROM Employee WHERE Position = @position Order By Name ASC"
    '        cmd.CommandType = CommandType.Text
    ...
    '        If dr.HasRows Then
    '            While dr.Read()
    '                CBO_Helper2.Items.Add(dr("Name").ToString())
    '                'CBO_Helper2.Text = dr("Emp_num").ToString()
    '            End While
    '            dr.Close()
    '            con.Close()
    ...
    '    Dim read_cmd_select_helper_empnum As SqlDataReader = Nothing
    ...
    '        read_cmd_select_helper_empnum = cmd_select_helper_empnum.ExecuteReader()
    ...
    '        MsgBox(ex.Message)
    '    Finally
    '        ' Ensure the data reader is closed
    '        If read_cmd_select_helper_empnum IsNot Nothing AndAlso Not read_cmd_select_helper_empnum.IsClosed Then
    '            read_cmd_select_helper_empnum.Close()
    '        End If
    ...
    Private Sub TXT_Dimension1_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TXT_Dimension1.KeyPress
        NumberOnly(e)
    End Sub

    Private Sub TXT_Dimension2_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TXT_Dimension2.KeyPress
        NumberOnly(e)
    End Sub

    Private Sub CHK_SeleclAll_CheckedChanged(sender As Object, e As EventArgs) Handles CHK_SeleclAll.CheckedChanged

        If CHK_SeleclAll.Checked = True Then
    ...
    Private Sub TXT_CottonGLovesQty_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TXT_CottonGLovesQty.KeyPress
        NumberOnly(e)
    End Sub



    Private Sub TXT_ReturnedCottonGloves_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TXT_ReturnedCottonGloves.KeyPress
        NumberOnly(e)
    End Sub
