...
Public Class UC_OperatorGluing
    ...
    Private Sub BTN_AddProductionRun_Click(sender As Object, e As EventArgs) Handles BTN_AddProductionRun.Click
        FRM_AddProductionRunGluing.Show()
        FRM_MonitoringChecklistMain.Hide()

    End Sub

    Private Sub UC_OperatorGluing_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub LoadRecord()
        ...
        While dr.Read()
            ...
            DataGridView1.Rows.Add("07:00", dr.Item("prr_GLFlywh0700"), dr.Item("prr_GLGluTnk0700"), dr.Item("prr_GLGluBotld0700"), dr.Item("prr_GLShiCa0700"), dr.Item("prr_GLFdrGS070809"), dr.Item("prr_GLExWkGl0700"), dr.Item("prr_GLExWkGl0700val"), dr.Item("prr_GLCrumSc0700"), dr.Item("prr_GLCrumSc0700val"), dr.Item("prr_GLOvrlap0700"), dr.Item("prr_GLOvrlap0700val"), dr.Item("prr_GLIncCnt0700"), dr.Item("prr_GLIncCnt0700val"), Convert.ToDecimal(total_0700).ToString("N0"))
            DataGridView1.Rows.Add("08:00", dr.Item("prr_GLFlywh0800"), dr.Item("prr_GLGluTnk0800"), dr.Item("prr_GLGluBotld0800"), dr.Item("prr_GLShiCa0800"), dr.Item("prr_GLFdrGS070809"), dr.Item("prr_GLExWkGl0800"), dr.Item("prr_GLExWkGl0800val"), dr.Item("prr_GLCrumSc0800"), dr.Item("prr_GLCrumSc0800val"), dr.Item("prr_GLOvrlap0800"), dr.Item("prr_GLOvrlap0800val"), dr.Item("prr_GLIncCnt0800"), dr.Item("prr_GLIncCnt0800val"), Convert.ToDecimal(total_0800).ToString("N0"))
            DataGridView1.Rows.Add("09:00", dr.Item("prr_GLFlywh0900"), dr.Item("prr_GLGluTnk0900"), dr.Item("prr_GLGluBotld0900"), dr.Item("prr_GLShiCa0900"), dr.Item("prr_GLFdrGS070809"), dr.Item("prr_GLExWkGl0900"), dr.Item("prr_GLExWkGl0900val"), dr.Item("prr_GLCrumSc0900"), dr.Item("prr_GLCrumSc0900val"), dr.Item("prr_GLOvrlap0900"), dr.Item("prr_GLOvrlap0900val"), dr.Item("prr_GLIncCnt0900"), dr.Item("prr_GLIncCnt0900val"), Convert.ToDecimal(total_0900).ToString("N0"))
            DataGridView1.Rows.Add("10:00", dr.Item("prr_GLFlywh1000"), dr.Item("prr_GLGluTnk1000"), dr.Item("prr_GLGluBotld1000"), dr.Item("prr_GLShiCa1000"), dr.Item("prr_GLFdrGS101112"), dr.Item("prr_GLExWkGl1000"), dr.Item("prr_GLExWkGl1000val"), dr.Item("prr_GLCrumSc1000"), dr.Item("prr_GLCrumSc1000val"), dr.Item("prr_GLOvrlap1000"), dr.Item("prr_GLOvrlap1000val"), dr.Item("prr_GLIncCnt1000"), dr.Item("prr_GLIncCnt1000val"), Convert.ToDecimal(total_1000).ToString("N0"))
            DataGridView1.Rows.Add("11:00", dr.Item("prr_GLFlywh1100"), dr.Item("prr_GLGluTnk1100"), dr.Item("prr_GLGluBotld1100"), dr.Item("prr_GLShiCa1100"), dr.Item("prr_GLFdrGS101112"), dr.Item("prr_GLExWkGl1100"), dr.Item("prr_GLExWkGl1100val"), dr.Item("prr_GLCrumSc1100"), dr.Item("prr_GLCrumSc1100val"), dr.Item("prr_GLOvrlap1100"), dr.Item("prr_GLOvrlap1100val"), dr.Item("prr_GLIncCnt1100"), dr.Item("prr_GLIncCnt1100val"), Convert.ToDecimal(total_1100).ToString("N0"))
            DataGridView1.Rows.Add("12:00", dr.Item("prr_GLFlywh1200"), dr.Item("prr_GLGluTnk1200"), dr.Item("prr_GLGluBotld1200"), dr.Item("prr_GLShiCa1200"), dr.Item("prr_GLFdrGS101112"), dr.Item("prr_GLExWkGl1200"), dr.Item("prr_GLExWkGl1200val"), dr.Item("prr_GLCrumSc1200"), dr.Item("prr_GLCrumSc1200val"), dr.Item("prr_GLOvrlap1200"), dr.Item("prr_GLOvrlap1200val"), dr.Item("prr_GLIncCnt1200"), dr.Item("prr_GLIncCnt1200val"), Convert.ToDecimal(total_1200).ToString("N0"))
            DataGridView1.Rows.Add("01:00", dr.Item("prr_GLFlywh0100"), dr.Item("prr_GLGluTnk0100"), dr.Item("prr_GLGluBotld0100"), dr.Item("prr_GLShiCa0100"), dr.Item("prr_GLFdrGS010203"), dr.Item("prr_GLExWkGl0100"), dr.Item("prr_GLExWkGl0100val"), dr.Item("prr_GLCrumSc0100"), dr.Item("prr_GLCrumSc0100val"), dr.Item("prr_GLOvrlap0100"), dr.Item("prr_GLOvrlap0100val"), dr.Item("prr_GLIncCnt0100"), dr.Item("prr_GLIncCnt0100val"), Convert.ToDecimal(total_0100).ToString("N0"))
            DataGridView1.Rows.Add("02:00", dr.Item("prr_GLFlywh0200"), dr.Item("prr_GLGluTnk0200"), dr.Item("prr_GLGluBotld0200"), dr.Item("prr_GLShiCa0200"), dr.Item("prr_GLFdrGS010203"), dr.Item("prr_GLExWkGl0200"), dr.Item("prr_GLExWkGl0200val"), dr.Item("prr_GLCrumSc0200"), dr.Item("prr_GLCrumSc0200val"), dr.Item("prr_GLOvrlap0200"), dr.Item("prr_GLOvrlap0200val"), dr.Item("prr_GLIncCnt0200"), dr.Item("prr_GLIncCnt0200val"), Convert.ToDecimal(total_0200).ToString("N0"))
            DataGridView1.Rows.Add("03:00", dr.Item("prr_GLFlywh0300"), dr.Item("prr_GLGluTnk0300"), dr.Item("prr_GLGluBotld0300"), dr.Item("prr_GLShiCa0300"), dr.Item("prr_GLFdrGS010203"), dr.Item("prr_GLExWkGl0300"), dr.Item("prr_GLExWkGl0300val"), dr.Item("prr_GLCrumSc0300"), dr.Item("prr_GLCrumSc0300val"), dr.Item("prr_GLOvrlap0300"), dr.Item("prr_GLOvrlap0300val"), dr.Item("prr_GLIncCnt0300"), dr.Item("prr_GLIncCnt0300val"), Convert.ToDecimal(total_0300).ToString("N0"))
            DataGridView1.Rows.Add("04:00", dr.Item("prr_GLFlywh0400"), dr.Item("prr_GLGluTnk0400"), dr.Item("prr_GLGluBotld0400"), dr.Item("prr_GLShiCa0400"), dr.Item("prr_GLFdrGS040506"), dr.Item("prr_GLExWkGl0400"), dr.Item("prr_GLExWkGl0400val"), dr.Item("prr_GLCrumSc0400"), dr.Item("prr_GLCrumSc0400val"), dr.Item("prr_GLOvrlap0400"), dr.Item("prr_GLOvrlap0400val"), dr.Item("prr_GLIncCnt0400"), dr.Item("prr_GLIncCnt0400val"), Convert.ToDecimal(total_0400).ToString("N0"))
            DataGridView1.Rows.Add("05:00", dr.Item("prr_GLFlywh0500"), dr.Item("prr_GLGluTnk0500"), dr.Item("prr_GLGluBotld0500"), dr.Item("prr_GLShiCa0500"), dr.Item("prr_GLFdrGS040506"), dr.Item("prr_GLExWkGl0500"), dr.Item("prr_GLExWkGl0500val"), dr.Item("prr_GLCrumSc0500"), dr.Item("prr_GLCrumSc0500val"), dr.Item("prr_GLOvrlap0500"), dr.Item("prr_GLOvrlap0500val"), dr.Item("prr_GLIncCnt0500"), dr.Item("prr_GLIncCnt0500val"), Convert.ToDecimal(total_0500).ToString("N0"))
            DataGridView1.Rows.Add("06:00", dr.Item("prr_GLFlywh0600"), dr.Item("prr_GLGluTnk0600"), dr.Item("prr_GLGluBotld0600"), dr.Item("prr_GLShiCa0600"), dr.Item("prr_GLFdrGS040506"), dr.Item("prr_GLExWkGl0600"), dr.Item("prr_GLExWkGl0600val"), dr.Item("prr_GLCrumSc0600"), dr.Item("prr_GLCrumSc0600val"), dr.Item("prr_GLOvrlap0600"), dr.Item("prr_GLOvrlap0600val"), dr.Item("prr_GLIncCnt0600"), dr.Item("prr_GLIncCnt0600val"), Convert.ToDecimal(total_0600).ToString("N0"))
