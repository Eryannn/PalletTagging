Public Class UC_NxtProcessLamination
    Private Sub BTN_Acknowledge_Click(sender As Object, e As EventArgs) Handles BTN_Acknowledge.Click
        Try
            ...
            UC_NxtProcessLam.Parent = FRM_MonitoringChecklistMain.PNL_MonitoringChecklistOperatorMain
    ...
    Private Sub UC_NxtProcessLamination_Load(sender As Object, e As EventArgs) Handles MyBase.Load
