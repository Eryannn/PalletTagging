Public Class UC_NxtProcessDieCutting
    Private Sub BTN_Acknowledge_Click(sender As Object, e As EventArgs) Handles BTN_Acknowledge.Click
        Try
            ...
            Dim UC_NxtProcessDieCuttingForm As New UC_NxtProcessDieCutting
            UC_NxtProcessDieCuttingForm.Parent = FRM_MonitoringChecklistMain.PNL_MonitoringChecklistOperatorMain
            UC_NxtProcessDieCuttingForm.Show()
            UC_NxtProcessDieCuttingForm.Dock = DockStyle.Fill
    ...
    Private Sub UC_NxtProcessDieCutting_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            OpenConnection()
