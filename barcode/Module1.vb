...
Module globalvariable
    Public app_version As String = "4.4.1" 'Changed from 4.4 to 4.4.1 - [Feature] Added Icon for SFMS.exe
    ...
    Public sppmchdr_existing_mcnum As Boolean

    Public joborder As String
    Public suffix As Integer
    Public oper_num As Integer

    Public empnum As String
    Public empname As String
    Public section_code As String
    Public user_site As String
    Public user_shift As String
    Public job_name As String

    Public isAdmin As String
    Public isSuperuser As String

    Public report_rdl As String
    Public sorter1_name As String
    Public sorter2_name As String


    Public con_Pisp As New SqlConnection("Data Source=ERP-SVR;Initial Catalog=PI-SP_App;User ID=sa;Password=pi_dc_2011")
    Public con_PalletTagging As New SqlConnection("Data Source=ERP-SVR;Initial Catalog=Pallet_Tagging;User ID=sa;Password=pi_dc_2011")
End Module
...
Module Module1
    ...
    Dim user As String = globalvariable.userid
    ...
    Function populateuser()
        Try
            ...
            cmdquery.Parameters.AddWithValue("@site", Form1.cmb_site.Text)
            Dim execquery As SqlDataReader = cmdquery.ExecuteReader
            While execquery.Read()
    ...
    Function login(ByVal userid As String, ByVal password As String, ByVal site As String)
        Try
	        ...
	        *  FROM Employee emp
	        LEFT join SectionMasterfile code on
		    code.SECTION like emp.SECTION WHERE Emp_num=@userid AND Password=@password AND Site=@site"
            Dim cmdquery As New SqlCommand(query, con)
            ...
            If hasrow Then
                ...
                Dim IsSuperUser As Boolean = Convert.ToBoolean(execquery("IsSuperUser"))


                If IsSuperUser AndAlso IsActive AndAlso IsAdmin Then
                    Form4.Show()
                    Form1.Hide()
                ElseIf IsActive AndAlso IsAdmin Then
                    globalvariable.empnum = Form1.cmbuserid.Text
                    globalvariable.empname = execquery("Name").ToString
                    globalvariable.section = execquery("Section").ToString
                    globalvariable.section_code = execquery("ZZCODE").ToString
                    globalvariable.position = execquery("Position").ToString
                    globalvariable.user_shift = Form1.cmbshift.Text
                    globalvariable.user_site = Form1.cmb_site.Text
                    FRM_ProcessJob.BTN_UserMaintenance.Visible = True
                    Form1.Hide()
                    FRM_ProcessJob.Show()
                ...
                ElseIf IsActive Then
                    ...
                    If useraccess = "REPORT" Then
                        If userrights = "VIEW" Then
                            ...
                            'Form2.lblsite_reports.Text = Form1.cmb_site.Text
                    ...
                    ElseIf useraccess = "TAGGING"
                        Dim form_process_job As New FRM_ProcessJob()
                        globalvariable.empnum = Form1.cmbuserid.Text
                        globalvariable.empname = execquery("Name").ToString
                        globalvariable.section = execquery("Section").ToString
                        globalvariable.section_code = execquery("ZZCODE").ToString
                        ...
                        globalvariable.user_shift = Form1.cmbshift.Text
                        globalvariable.user_site = Form1.cmb_site.Text
                        'globalvariable.isAdmin = execquery("IsAdmin").ToString 'added 20 JANUARY 2025 5:28PM
                        ' globalvariable.isSuperuser = execquery("IsSuperUser").ToString 'added 20 JANUARY 2025 5:28PM
                        form_process_job.Show()

                        Form1.Hide()
                        'form_process_job.lbl_empnum.Text = Form1.cmbuserid.Text
                        'form_process_job.lbl_empname.Text = execquery("Name").ToString

                        'section = execquery("Section").ToString

                        'Dim form2 As New Form2()
                        'form2.txtoper_num.Text = Form1.cmbuserid.Text
                        'form2.txtoper_numt3.Text = Form1.cmbuserid.Text
                        'form2.TextBox3.Text = Form1.cmb_site.Text
                        ...
                        'form2.txtsite_subcon.Text = Form1.cmb_site.Text
    ...
    Function check_app_version()
        ...
        Try
            con.Open()
            Dim cmd As New SqlCommand("Select * FROM sfms_Maintenance Where Application = 'PALLET_TAGGING'", con)
