...
Public Class frm_preview_outputvolumereport
    ...
    Private Sub frm_preview_outputvolumereport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim reportPath As String = System.IO.Path.Combine(Application.StartupPath, "\\192.168.10.27\Shopfloor_Folder\HYDRA PROJECT\RDL\IT_RPT_OutputVolumeReport.rdl")
        ...
        reportParameters.Add(New ReportParameter("section", Frm_Transaction_Summary_Report.cmb_section.Text))
    ...
    Private Function GetData() As DataTable
        ...
        Try
            ...
            Dim cmd_timeeval_rpt As New SqlCommand("IT_RPT_OutputVolumeReport", con_pallet)
            cmd_timeeval_rpt.CommandType = CommandType.StoredProcedure

            cmd_timeeval_rpt.Parameters.AddWithValue("section", SqlDbType.NVarChar).Value = Frm_Transaction_Summary_Report.cmb_section.Text
