Public Class FRM_AddProductionRunGluingLamina
    ...
    Private Sub BTN_SaveProductionRun_Click(sender As Object, e As EventArgs) Handles BTN_SaveProductionRun.Click
        ...
        Dim selectedCrumpled As String = ""
            ...
            If dr.HasRows Then
                ...
                For Each vartime As String In times
                    ...
                    With cmd.Parameters
                        ...
                        .AddWithValue("@prr_GLCrumSc", selectedCrumpled)
    ...
    Private Sub FRM_AddProductionRunGluingLamina_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            OpenConnection()
