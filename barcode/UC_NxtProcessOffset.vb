Public Class UC_NxtProcessOffset
    Private Sub BTN_Acknowledge_Click(sender As Object, e As EventArgs) Handles BTN_Acknowledge.Click
        ...
        Try
            ...
            UC_NxtProcessOff.Parent = FRM_MonitoringChecklistMain.PNL_MonitoringChecklistOperatorMain
    ...
    Private Sub UC_NxtProcessOffset_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            OpenConnection()
