Public Class UC_NxtProcessQC
    Private Sub BTN_Acknowledge_Click(sender As Object, e As EventArgs) Handles BTN_Acknowledge.Click
        Try
            ...
            Dim UC_NxtProcessQCMach As New UC_NxtProcessQC
            UC_NxtProcessQCMach.Parent = FRM_MonitoringChecklistMain.PNL_MonitoringChecklistOperatorMain
            UC_NxtProcessQCMach.Show()
            UC_NxtProcessQCMach.Dock = DockStyle.Fill
    ...
    Private Sub UC_NxtProcessQC_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            OpenConnection()
